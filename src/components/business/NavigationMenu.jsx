                ...
                <div className="relative px-4 py-6 flex items-center justify-between border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            ...
                            <div className="relative flex items-center justify-center w-10 h-10 bg-blue-50 rounded-xl ring-1 ring-gray-100">
                ...
                <nav className="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                  ...
                  ${isActive
                            ...
                            >
                                ...
                                <div className={`relative ${isActive ? 'text-blue-600' : 'text-gray-400'}`}>
                                    <Icon className={`w-6 h-6 transition-transform duration-200 ${isHovered ? 'scale-110' : 'scale-100'}`} />
