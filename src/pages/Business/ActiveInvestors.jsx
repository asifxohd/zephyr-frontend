          ...
          <div className="flex items-start justify-between mb-3 sm:mb-4">
            <div className="flex items-start space-x-3 sm:space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 truncate group-hover:text-blue-600 transition-colors duration-300">
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm px-3 sm:px-4 py-1.5 rounded-lg transition-all duration-200 flex-shrink-0 hover:shadow-lg transform hover:-translate-y-0.5">
              Connect
            </button>
          </div>
