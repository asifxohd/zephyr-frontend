    ...
    return (
        <div className="flex items-center justify-center h-screen">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full">
                ...
                <p className='mb-3 text-center'>Enter the code we sent to your Mobile number <br /> <span className='text-blue-300'>+91 XXXX XXX XXXX</span> be careful <br /> not to share the code with anyone </p>
                ...
                <div className="flex justify-center">
                    <button onClick={handleVerifyOTP} className="w-full bg-black text-white py-2 px-4 rounded-lg hover:bg-gray-800 focus:outline-none">Verify OTP</button>
                </div>

                <p className='text-center mt-3 text-gray-500'>Didn't Receive an OTP? <br /><button onClick={handleResendOTP} className='text-black'>Resend OTP</button></p>
            </div>
        </div>
    );
}
